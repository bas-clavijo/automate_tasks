# Script para busqueda de trabajo
import requests
from bs4 import BeautifulSoup #libreria para poder hacer web scrapper
...
#py scrapper.py >> jobs.txt
#creacion del archivo txt con la informacion detallada, esta informacion ira dependiendo del link y la busqueda actual